...
The code side of the estate — library CVEs and static-analysis weaknesses — is measured by
[`brick/devsecops/`](devsecops/README.md), which is a **separate, self-contained deployment**
