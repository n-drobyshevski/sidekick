...
// ~170KB of the whole design system, inlined into every response — worth it for the app,
// absurd for a card with two sentences on it, and in the denial case it would ship the design
// system to someone being turned away. The handful of rules below are the src/client/styles
// tokens the card actually uses, resolved to their literal values, and nothing else.
 ...
 *
 * aria-hidden, never labelled: it sits beside the words "Wiz Sidekick DevSecOps" here exactly as it
