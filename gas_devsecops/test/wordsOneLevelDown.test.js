...
// `verdictMark` moved out of program.js into gas_shared/ui/verdict.js (repos.js's Capacity
...
const VERDICT_CODE = code(readFileSync(new URL("../../gas_shared/ui/verdict.js", import.meta.url), "utf8"));
...
describe("program — the same, on the coverage lane", () => {
  ...
  it("gives the capacity verdict a dot AND a word", () => {
    ...
    // label — verdictMark's DOM (the dot, the word, its aria-hidden-ness) is verdict.js's
