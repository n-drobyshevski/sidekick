...
| **Data / Settings** | Sync history, storage stats, reset; default depth, node budget, credential status, the 5Rs policy scope, and **Show experimental content** — off by default, and the only thing that puts Scoring Models in the sidebar. |
