 ...
 * name would orphan an entire generation of files whenever the stamp moves — every sync, and
 * every CACHE_EPOCH bump. Deterministic names mean a rewrite replaces rather than accumulates.
 */
