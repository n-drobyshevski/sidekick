 ...
 * about one asset. `aarsChip` itself is unchanged and stays correct where a band is a
 * MODEL diagnostic rather than a claim — the AARS trend, the AARS Rules page's band
 * movers and sandbox.
 */
export function aarsPercentileMark(percentile, score) {
  if (percentile === null || percentile === undefined || score === null || score === undefined) {
    return el("span", { class: "muted small" }, "—");
  }
