...
function lexiconShell(shown, hidden) {
  ...
  // The whole paragraph, not just its button: every clause of it is about what the code
  // reference holds, so with that page gated the prose would be describing a room the
  // reader cannot enter. The vocabularies themselves stay in the lexicon above — they are
  // read on AI Inventory too — they simply lose the deeper reference.
