...
/** The account and project values actually present, for the two select fields. */
export function issueFilterOptions(rows) {
  ...
  return { accounts: sorted(accounts), projects: sorted(projects) };
}
...
export const ISSUE_SORT_DESC = { severity: true, native: true };
