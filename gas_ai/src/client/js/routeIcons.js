...
export const LANE_ICONS = {
  ...
  // The Data lane's mark, shared with both sibling registers — stacked trays, the stored
  // record. This lane is new here: Storage and the Key sheet used to sit loose in the chrome
  // tail. Deliberately not the cylinder its own Storage page draws, and deliberately not the
  // ruled rows gas_devsecops used to draw for this lane, which are all but `aars` below.
  Data: trays,
};
//
