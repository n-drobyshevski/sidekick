...
// stand in for: that `parsePages()` reads gas_ai's REAL app.js and comes back with gas_ai's
...
describe("parsePages() against gas_ai's own app.js — the route list `npm run density` walks", () => {
